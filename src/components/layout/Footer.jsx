      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            <Link to="/" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="inline-flex items-center gap-2 group">
              ...
              <span className="font-heading text-2xl font-bold tracking-wide text-white group-hover:text-purple-bright transition-colors">
                Luxur
              </span>
            </Link>
          ...
          {/* Column 4: Newsletter */}
          <motion.div variants={itemVariants}>
            <h3 className="font-heading text-xl font-semibold mb-6 text-white">Newsletter</h3>
